...
##############################################
$SQLInstance = "localhost\SQLEXPRESS01"
...
# Invoke-SQLCmd -Query $SQLCreateDB -ServerInstance $SQLInstance -Credential $cred
Invoke-SQLCmd -Query $SQLCreateDB -ServerInstance  $SQLInstance 
##############################################
# Creating SQL Table
##############################################
...
Invoke-SQLCmd -Query $SQLCreateTable -ServerInstance $SQLInstance
##############################################
# End of script
##############################################